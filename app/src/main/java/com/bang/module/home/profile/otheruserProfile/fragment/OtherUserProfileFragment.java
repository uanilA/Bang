...
public class OtherUserProfileFragment extends BaseFragment implements ApiCallback.OtherUserCallback,View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        mLastClickTime = SystemClock.elapsedRealtime();
         switch (v.getId()){
             case R.id.tvFollow:
                 new OtherUserPresenter(this,mContext).callFollowApi(mParam1);
                 break;
