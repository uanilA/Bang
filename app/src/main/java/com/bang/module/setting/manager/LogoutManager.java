...
public class LogoutManager {
    ...
    public LogoutManager(ApiCallback.CheckSocialCallback checkSocialCallback , Context mContext) {
        this.checkSocialCallback = checkSocialCallback;
        this.mContext=mContext;
    }

    public void callLogoutApi(String countryCode,String mobileNumber){
